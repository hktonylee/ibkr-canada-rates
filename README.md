...
This repository contains the daily IBKR Canada interest and margin rates, with the latest snapshots available in [`data/2025/11/08/ibkr-canada-interest-rates.csv`](data/2025/11/08/ibkr-canada-interest-rates.csv) and [`data/2025/11/08/ibkr-canada-margin-rates.csv`](data/2025/11/08/ibkr-canada-margin-rates.csv).
...
<p align="center">
  <img src="./assets/2025-11-08/usd-margin-100000.svg" alt="Historical USD margin rate for $100,000 borrowed" width="720" />
</p>
